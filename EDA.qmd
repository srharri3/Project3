...
```{r}
bar1 <- ggplot(diabetes, aes(x = )) + geom_bar(fill = "skyblue") + labs(title = "Distribution of Education Levels", x + "Education Level", y = "Count")
bar1
```

```{r}
box1 <- ggplot(diabetes, aes(x = Age, y = BMI)) +
  geom_boxplot(fill = "skyblue") +
  labs(title = "BMI distribution by Age")
box1
```
